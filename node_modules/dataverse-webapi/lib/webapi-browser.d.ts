 ...
 * @param queryOptions Various query options for the query
 */
export declare function retrieveMultipleNextPage(apiConfig: WebApiConfig, url: string, queryOptions?: QueryOptions): Promise<RetrieveMultipleResponse>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function create(apiConfig: WebApiConfig, entitySet: string, entity: Entity, queryOptions?: QueryOptions): Promise<void>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function update(apiConfig: WebApiConfig, entitySet: string, id: string, entity: Entity, queryOptions?: QueryOptions): Promise<void>;
/**
 * Create a record in CRM and return data
 * @param apiConfig WebApiConfig object
 * @param entitySet Type of entity to create
 ...
 * @param queryOptions Various query options for the query
 */
export declare function updateProperty(apiConfig: WebApiConfig, entitySet: string, id: string, attribute: string, value: unknown, queryOptions?: QueryOptions): Promise<void>;
/**
 ...
 */
export declare function deleteRecord(apiConfig: WebApiConfig, entitySet: string, id: string): Promise<void>;
/**
 ...
 */
export declare function deleteProperty(apiConfig: WebApiConfig, entitySet: string, id: string, attribute: string): Promise<void>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function associate(apiConfig: WebApiConfig, entitySet: string, id: string, relationship: string, relatedEntitySet: string, relatedEntityId: string, queryOptions?: QueryOptions): Promise<void>;
/**
 ...
 */
export declare function disassociate(apiConfig: WebApiConfig, entitySet: string, id: string, property: string, relatedEntityId?: string): Promise<void>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function boundAction(apiConfig: WebApiConfig, entitySet: string, id: string, actionName: string, inputs?: Record<string, unknown>, queryOptions?: QueryOptions): Promise<unknown>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function unboundAction(apiConfig: WebApiConfig, actionName: string, inputs?: Record<string, unknown>, queryOptions?: QueryOptions): Promise<unknown>;
/**
 * Execute a default or custom bound action in CRM
 * @param apiConfig WebApiConfig object
 * @param entitySet Type of entity to run the action against
 ...
 * @param queryOptions Various query options for the query
 */
export declare function boundFunction(apiConfig: WebApiConfig, entitySet: string, id: string, functionName: string, inputs?: FunctionInput[], queryOptions?: QueryOptions): Promise<unknown>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function unboundFunction(apiConfig: WebApiConfig, functionName: string, inputs?: FunctionInput[], queryOptions?: QueryOptions): Promise<unknown>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function batchOperation(apiConfig: WebApiConfig, batchId: string, changeSetId: string, changeSets: ChangeSet[], batchGets: string[], queryOptions?: QueryOptions): Promise<unknown>;

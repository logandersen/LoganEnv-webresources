...
declare type RequestCallback = (config: WebApiRequestConfig, callback: (result: WebApiRequestResult) => void) => void;
 ...
 * @param queryOptions Various query options for the query
 */
export declare function updateProperty(apiConfig: WebApiConfig, entitySet: string, id: string, attribute: string, value: unknown, submitRequest: RequestCallback, queryOptions?: QueryOptions): Promise<void>;
/**
